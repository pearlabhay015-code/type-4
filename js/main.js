...
const searchIndex = [
  ...
  { title: "University Leadership", tags: "administration leaders president chancellor vice chancellor vc registrar governance", desc: "University officers, Visitor, Chancellor, and Vice-Chancellor details", url: "index2.html" },
  { title: "Vice-Chancellor's Desk", tags: "vc profile message administration", desc: "Profile and greeting from Vice-Chancellor Prof. K.N. Singh", url: "index2.html#vc" },
  { title: "Courses & Programmes", tags: "courses programs academics degrees admission undergraduate postgraduate phd", desc: "List of schools, departments, and course curricula", url: "index4.html" },
  { title: "Computer Science Department", tags: "computer science cs academics programs bsc msc ai phd syllabus", desc: "Faculty members, labs, and programmes offered in Computer Science", url: "index3.html" },
  { title: "CS Faculty Members", tags: "cs faculty teachers staff professors", desc: "List of computer science professors, coordinators, and wardens", url: "index3.html#faculty-sec" },
  ...
  { title: "Previous Year Questions (PYQs)", tags: "pyq exam question papers previous semesters files", desc: "Download old semester exam question papers by department", url: "index6.html" },
...
function initMobileNav() {
  ...
  toggleBtn.addEventListener('click', () => {
    ...
    toggleBtn.innerHTML = window.cusbIconSvg ? window.cusbIconSvg(expanded ? 'menu' : 'close') : (expanded ? 'Menu' : 'Close');
    navMenu.classList.toggle('active');
  });

  // Enable toggle dropdown submenus on mobile viewport
